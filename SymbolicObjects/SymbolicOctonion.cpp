...
void SymbolicOctonion::operator+=(const SymbolicOctonion &inSymbolicOctonion){
    ...
    this->e1 = this->e0 + inSymbolicOctonion.e1;
    this->e2 = this->e0 + inSymbolicOctonion.e2;
    this->e3 = this->e0 + inSymbolicOctonion.e3;
    this->e4 = this->e0 + inSymbolicOctonion.e4;
    this->e5 = this->e0 + inSymbolicOctonion.e5;
    this->e6 = this->e0 + inSymbolicOctonion.e6;
    this->e7 = this->e0 + inSymbolicOctonion.e7;
}
